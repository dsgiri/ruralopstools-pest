...
export default function App() {
  ...
  useEffect(() => {
    ...
    const seoData: Record<ViewState | string, { title: string; description: string }> = {
      Home: { title: 'Pest Management Dashboard | RuralOpsTools Pest', description: 'Overview of pest risks, scouting logs, and agricultural compliance.' },
      Risk: { title: 'Pest Risk Forecast | RuralOpsTools Pest', description: 'Advanced degree-day accumulation and pest risk forecasting.' },
      Disease: { title: 'Crop Disease Models | RuralOpsTools Pest', description: 'Monitor infection conditions and plant disease outbreak probabilities.' },
      Scouting: { title: 'Field Scouting Logs | RuralOpsTools Pest', description: 'Digital scouting records, pest identification, and field observation logs.' },
      Traps: { title: 'Trap Count Tracker | RuralOpsTools Pest', description: 'Record and visualize pheromone trap counts for moth flights and insect swarms.' },
      Spray: { title: 'Spray Records & Compliance | RuralOpsTools Pest', description: 'Manage EPA-compliant spray records and pesticide application logs.' },
      Alerts: { title: 'Threshold Alerts | RuralOpsTools Pest', description: 'Automated push alerts for economic pest thresholds and weather risks.' },
      Favorites: { title: 'Favorite Tools | RuralOpsTools Pest', description: 'Quick access to your most used pest management tools.' },
      Calculators: { title: 'Agricultural ROI Calculators | RuralOpsTools Pest', description: 'Interactive tools for economic thresholds, spray timing, and GDD accumulation.' },
      About: { title: 'About Us | RuralOpsTools Pest', description: 'Learn about RuralOpsTools Pest and our mission to optimize pest management.' },
      Contact: { title: 'Contact Support | RuralOpsTools Pest', description: 'Get in touch with the RuralOpsTools Pest support and agricultural advisory team.' },
      Legal: { title: 'Terms & Privacy | RuralOpsTools Pest', description: 'Legal terms, privacy policy, and compliance information for RuralOpsTools Pest.' },
      Privacy: { title: 'Privacy Policy | RuralOpsTools Pest', description: 'Privacy policy detailing data collection, usage, and storage for RuralOpsTools Pest.' },
      License: { title: 'Software License | RuralOpsTools Pest', description: 'Software licensing information and open source attributions.' },
      '/calculators/degree-days': { title: 'GDD Calculator | RuralOpsTools Pest', description: 'Degree-day accumulation calculator.' },
      '/calculators/economic-threshold': { title: 'Economic Threshold Calculator | RuralOpsTools Pest', description: 'Economic threshold calculator for spraying.' },
      '/calculators/spray-window': { title: 'Spray Timing Window | RuralOpsTools Pest', description: 'Spray timing window checker.' },
      '/calculators/trap-roi': { title: 'Trap Count ROI | RuralOpsTools Pest', description: 'Trap count ROI estimator.' },
    };
